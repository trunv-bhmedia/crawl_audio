        ...
        <div class="w-full px-4 py-6 sm:px-6 lg:px-8 2xl:px-10">
            <header class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-600">Dựng UI trước (mock data). Sau này có thể thay bằng dữ liệu DB mà không đổi layout.</p>
                </div>
                ...
                <aside class="lg:col-span-3">
                    <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                        <div class="border-b border-slate-100 px-4 py-4">
                            ...
                            <div class="mt-1 text-xs text-slate-500">Chuyển nhanh giữa các màn hình.</div>
                        </div>
                        <nav class="p-2">
                            <a
                                href="{{ route('crawled-tracks.index', array_filter(['view' => 'songs'])) }}"
                            ...
                            <a
                                href="{{ route('crawled-tracks.index', array_filter(['view' => 'artists'])) }}"
                        ...
                        <div class="border-t border-slate-100 px-4 py-4">
                            <div class="text-xs text-slate-600">
                                Lưu ý: hiện tại đang dùng <span class="font-medium">mock data</span> để dựng giao diện.
                            </div>
                        </div>
                    </div>
                </aside>
                ...
                <main class="lg:col-span-9">
                    <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                            ...
                            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    ...
                                    <div class="mt-1 text-xs text-slate-500">
                                        {{ $activeView === 'artists' ? 'Lọc theo site, tên nghệ sĩ và số lượng bài.' : 'Lọc theo site, từ khóa, trạng thái URL/file.' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($activeView === 'artists')
                            <form method="get" action="{{ route('crawled-tracks.index') }}" class="border-b border-slate-100 px-4 py-4 sm:px-6">
                                ...
                                <div class="mt-4 flex flex-wrap items-center gap-3">
                                    ...
                                    <a href="{{ route('crawled-tracks.index', ['view' => 'artists']) }}" class="text-sm font-medium text-slate-600 hover:underline">Reset</a>
                                </div>
                            </form>
                        ...
                        @else
                            <form method="get" action="{{ route('crawled-tracks.index') }}" class="border-b border-slate-100 px-4 py-4 sm:px-6">
                                ...
                                <div class="mt-4 flex flex-wrap items-center gap-3">
                                    ...
                                    <a href="{{ route('crawled-tracks.index', ['view' => 'songs']) }}" class="text-sm font-medium text-slate-600 hover:underline">Reset</a>
                                </div>
                            </form>
                    ...
                    <div class="mt-4 rounded-xl border border-slate-200 bg-white px-4 py-4 text-sm text-slate-600 shadow-sm sm:px-6">
                        <div class="font-medium text-slate-800">Gợi ý bước tiếp theo</div>
                        <ul class="mt-2 list-disc pl-5">
                            <li>Gắn dữ liệu thật từ DB (Eloquent) vào biến `$tracks` và/hoặc thêm endpoint artists.</li>
                            <li>Thêm link “Xem bài hát” ở màn Nghệ sĩ để mở danh sách bài theo nghệ sĩ.</li>
                            <li>Nếu crawl nhiều, nên dùng Queue để tránh timeout (theo `.cursorrules`).</li>
                        </ul>
                    </div>
                </main>
            </div>
